...
# R1d — the UPDATE faces of the same contract (#1519/#1522): ghost-parent
...
# R1d-happy (#1519, this lane): the update contract's accept arm — PATCH
# retargeting to an EXISTING own workflow 200s and persists.
