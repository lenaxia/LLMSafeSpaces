    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/workflows/:workflowId/runs/:runId", element: <RunDetailPage /> },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "images", element: <WorkspaceImagesTab scope="org" /> },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "image-factory", element: <WorkspaceImagesTab scope="platform" /> },
