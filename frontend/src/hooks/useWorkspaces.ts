 ...
 * session_index — persisted by the API's usage-stream bridge from
 * MESSAGE_END usage. Real-time updates arrive via the contract stream
 * (/contract-events, US-69.10).
 */
