...
// probe (#1302 / #1310 slice A). reply="reject" on a question id is the
// dismiss exit (question-reject endpoint first, permission fallback). The
// optional message carries deny-feedback alongside a permission reply
// (preserves the field the raw passthrough carried, #1302 / 4a).
