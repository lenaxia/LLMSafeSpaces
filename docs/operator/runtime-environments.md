...
FROM ghcr.io/lenaxia/llmsafespaces/base:0.4.0
...
docker pull ghcr.io/lenaxia/llmsafespaces/base:0.4.0
docker pull ghcr.io/lenaxia/llmsafespaces/api:0.4.0
docker pull ghcr.io/lenaxia/llmsafespaces/controller:0.4.0

# Retag and push to your private registry
docker tag ghcr.io/lenaxia/llmsafespaces/base:0.4.0 \
    registry.internal:5000/sandboxes/base:0.4.0
docker push registry.internal:5000/sandboxes/base:0.4.0
