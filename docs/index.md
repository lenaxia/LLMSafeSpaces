...
**v0.4.5** — Active development. Suitable for homelab and small-team deployments with the threat model understood. Not recommended for public multi-tenant SaaS without reviewing the [threat model](architecture/threat-model.md).
