...
- `pkg/workflows/store.go`: `WorkspaceExistsByID` — the UNSCOPED existence primitive (the FKs' semantics; ownership NOT judged — cross-owner targets remain the fire-time loud class). Same pool, one COUNT.
