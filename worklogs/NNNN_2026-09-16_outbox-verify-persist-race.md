...
5. *The env seam cannot narrow production budgets.* Validated: `ParseDuration` errors and `d <= 0` fall through to the consts; only the size test sets the vars.
