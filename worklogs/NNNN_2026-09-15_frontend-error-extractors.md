...
- Gates: vitest **1836/1836** (168 files), tsc **0**, Playwright `history-error-banner.spec.ts` **2/2**. Repo-wide grep: the dead string survives only in the #796-flagged pre-existing `useChatStream.ts` comment and the gate's own pattern table.
