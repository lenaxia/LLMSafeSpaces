...
- r14: [correction — this line previously cited 34723719081 as the head-exact dispatch; that run was CANCELLED when the head moved to 0daa70d3 (the header-clause fix). The head-exact dispatch on the FINAL head is **34724999271**.]
- **Gate citation (r16, truthful): run [34724999271](https://github.com/lenaxia/LLMSafeSpaces/actions/runs/34724999271) = SUCCESS on 0daa70d3 — F1 PASS (00:03:47), AC-1b/AC-1e PASS, F2–F5 PASS. F6's faulted-boot row SKIPPED in this run (the pre-existing arm-budget flake: the dedicated re-arm's faults were consumed before the probe observed one — F6 PASS under earlier runs 34566214570/34618847909/34711974833; probe_seam covers its detection path identically). The F6 flake is upstream of this PR's mechanism and unclaimed by it.]
