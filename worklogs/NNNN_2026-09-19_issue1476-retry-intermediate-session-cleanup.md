...
- Task 2 (transport-error/script_timeout blindness) prepared as a design proposal for the orchestrator — sent via message, NOT implemented (wire-shape decision is above this lane).
...
- `api/internal/workflows/engine_retry_cleanup_test.go` — new (7 tests + sequenceAgentd executor)
