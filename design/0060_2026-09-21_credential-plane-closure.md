...
**Q5/R5 — (a)+(b):** file the upstream FD-delivery ask AND ship the spawn-env payload redaction interim now (the env surface shrinks to one process's boot-time state today; the pinned binary untouched).
