...
| R2b fix | #1165 | file-class ownership flip: sidecar stages manifest, uid-1000 supervisor writes; manifest-scoped reset; per-type mode contracts; `files_rev`; R3 schema growth (owner-uid + consumer-constraint) | open — **blocks US-70.5** |
