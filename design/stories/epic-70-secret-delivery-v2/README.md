...
|---|---|---|---|
| US-70.0 | #1182 | delivery test harness (API fault injection, key-row corruption, SA-token time-travel, gVisor load, chaos-kill) | **landed 2026-08-31** (#1187) + AC-1 harness fixes (#1197 resolution/metadata, #1199 session auth — pool re-dispatch pending) |
