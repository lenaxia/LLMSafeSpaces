...
| US-70.2 | #1183 | one builder + two-tier revisions (R1, covers the file manifest) + conditional pull endpoint | implementation complete — PR in review (2026-08-31); absorbs the #1165 manifest into the revision model |
