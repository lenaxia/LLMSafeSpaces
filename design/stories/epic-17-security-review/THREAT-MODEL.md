...
| G46 | Password file read failure is silent | Low | 🔴 Open | `cmd/workspace-agentd/main.go:134-140` (file:line updated; original row cited `main.go:753-757` which no longer exists) — `readAgentPassword` returns empty string on file-read error; workspace starts silently non-functional. | Log at Error level, consider non-zero exit. |
...
**Open gaps (require remediation):** G6, G9, G13, G21, G41, G42, G43, G44, G46, G47
