...
|-------|------|---------------|--------|---------|
| opencode-orchestrator (epic-72) | Orchestrate US-72.2→72.6 to merged completion; US-72.2 BYO resolve router + post-merge quota-admission race fix (PR #1432, approved r8) | `cmd/relay-router/byo*`, `helm/templates/llm-relay*`, own worklogs | In Progress — merging #1432, then delegating US-72.3→72.6 to per-story agent sessions | 2026-09-17 |
