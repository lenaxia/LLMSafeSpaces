...
|-------|------|---------------|--------|---------|
| opencode (g35) | G35 — /account/recover rate limit (per-endpoint) | `api/internal/middleware/rate_limit.go`, `api/internal/middleware/rate_limit_test.go` (new), `api/internal/server/router.go` | In Progress | 2026-07-11 |
