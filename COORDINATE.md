...
|-------|------|---------------|--------|---------|
| opencode (epic-72 / US-72.2→72.6) | Finish Epic 72: US-72.2 BYO resolve router, US-72.3 controller staging, US-72.4 token emission, US-72.5 flip/runbook, US-72.6 scrub+sweep (US-72.1 done — PR #1407 APPROVED, unmerged; stories stack on it) | `cmd/relay-router/byo*`, `cmd/relay-router/main.go`, `helm/templates/llm-relay*`, `helm/templates/{rbac,namespace,values,prometheus-rules}*.yaml` (additive), `controller/internal/workspace/staging*`, `pkg/apis/llmsafespaces/v1/workspace_types.go` (conditions), `pkg/secrets/{injection,batch}.go` (flag-gated), `cmd/workspace-agentd/{relay_liveness,scrub_legacy_keys}*.go`, `local/us-72-*`, `design/stories/epic-72-*/**`, own worklogs | In Progress | 2026-09-17 || opencode (epic-71 / flake-verify-race) | #1312 flake fixes: outbox-verify persistFirst data race + 3 contended agentd tests | `api/internal/handlers/proxy_outbox_verify_test.go`, `cmd/workspace-agentd/session_aware_restart_1342_test.go`, `cmd/workspace-agentd/spawn_env_pull_test.go`, `cmd/workspace-agentd/spawn_env_pull.go`, `cmd/workspace-agentd/spawn_files_pull.go`, `cmd/workspace-agentd/spawn_files_size_exec_test.go` | DONE — PR #1408 APPROVED, conflict-resolve merge 2026-09-17, re-verified | 2026-09-16 |origin/main
